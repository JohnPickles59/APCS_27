...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        int rizzPower = ((int)(Math.random()*10)+30);
        int sigmaSpeed = ((int)(Math.random()*10)+30);
        int brainrotEnergy = (((int)(Math.random()*5)+25)/2);
        ...
        int movePower = (int)(Math.random()*5)+20;
        ...
        int rivalDefense = (int)(Math.random()*5)+20;
        ...
        double fateRoll = (Math.random()*0.5)+ 2;
        boolean maxRizz = true;
        ...
        int rivalHealthRemaining = rivalHealth - Math.max(0,finalDamage);
        ...
        double rivalFuryRoll = (Math.random()*1) + 1.5;
        ...
        int basePoints = (int)(Math.random()*50)+300;
